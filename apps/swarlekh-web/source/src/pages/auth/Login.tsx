...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex" style={{background:'linear-gradient(135deg,#0A1628 0%,#1E3A5F 50%,#0A1628 100%)'}}>
      {/* Left */}
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            <div className="flex items-center gap-3 mb-2 lg:hidden">
              <div className="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center"><Mic size={18} color="white" /></div>
              <span className="text-lg font-bold text-gray-900">SwarLekh</span>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                ...
                <input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)}
                  className="input-field" placeholder="you@example.com" autoComplete="email" aria-required="true" />
              </div>
              <div>
